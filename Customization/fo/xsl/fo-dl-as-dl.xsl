...
<!-- =======================================================
     ...
     Override for base handling of definition lists. Renders
     them as definition lists using blocks rather than using
     tables.
     
     This is an extension to the base PDF2 transformation type.
     It should work with any version of the OT that provides
     the "commonattributes" named template.
